...
class ComputeShader {
    ...
    func buildPipeline(_ shaderFunction:String) -> MTLComputePipelineState {
        ...
        do {
            let defaultLibrary = gDevice?.newDefaultLibrary()
    ...
    func processGridPower(_ grid:inout [TVertex]) {
        ...
        encoder.setBuffer(gBuffer, offset: 0, at: 0)
        encoder.setBuffer(bBuffer, offset: 0, at: 1)
        encoder.setBuffer(cBuffer, offset: 0, at: 2)
    ...
    func processBallMovement() {
        ...
        encoder.setBuffer(bBuffer, offset: 0, at: 0)
        encoder.setBuffer(cBuffer, offset: 0, at: 1)
        encoder.dispatchThreadgroups(numThreadgroups, threadsPerThreadgroup: threadsPerGroup)
        encoder.endEncoding()
