...
vertex ColorInOut lighting_vertex(device TVertex* vertex_array [[ buffer(0) ]],
...
fragment float4 textureFragment(ColorInOut data [[stage_in]],
...
kernel void calcGridPower(device TVertex *grid [[ buffer(0) ]],
...
kernel void calcGridPower2(device TVertex *grid [[ buffer(0) ]],
                          const device BallData *ballData [[ buffer(1) ]],
                          uint id [[ thread_position_in_grid ]])
{
...
kernel void calcBallMovement(device BallData *ballData [[ buffer(0) ]],
