    ...
    func configure(_ view: AAPLView) {
        ...
        do {
            if #available(OSX 10.12, *) {
                ...
                try png1 = tLoad.newTexture(withName:"p10", scaleFactor:1, bundle: Bundle.main, options:nil)
...
//        psd.destinationAlphaBlendFactor = .oneMinusSourceAlpha
    ...
    func render(_ view: AAPLView) {
        ...
        if let samplerState = samplerState { renderEncoder?.setFragmentSamplerState(samplerState, at: 0) } else { return } // zorro
